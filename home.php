...
$sqlQuery = "SELECT activity_id, lecturer_name, acadimic_title,activity_type,activity_type_id, activity_date, activity_to_date,university_order_date,acadimic_title_order_date, activity_name,major,specialty, activity_place, participation_type ,file , image FROM (
                SELECT ai.activity_id, l.lecturer_name,null as acadimic_title, a_t.activity_type, a_t.activity_type_id, ai.activity_date,ai.activity_to_date,null as university_order_date,  null as acadimic_title_order_date,  ai.activity_name,null as major, null as specialty, ai.activity_place, pt.participation_type, f.file ,i.image
                ...
                UNION
                SELECT com.activity_id, l.lecturer_name,null as acadimic_title, a_t.activity_type, a_t.activity_type_id, com.activity_date, NULL AS activity_to_date,null as university_order_date ,null as acadimic_title_order_date,  com.activity_name,null as major, null as specialty, com.activity_place, NULL AS participation_type, f.file ,i.image
                FROM committees com
                ...
                UNION
                SELECT pro.promotion_id AS activity_id , l.lecturer_name, act.acadimic_title, a_t.activity_type, a_t.activity_type_id, null AS activity_date ,null AS activity_to_date, pro.university_order_date, pro.acadimic_title_order_date,pro.activity_name, pro.major, pro.specialty ,null as activity_place, NULL AS participation_type, f.file , NULL AS image
                FROM promotions pro
...
<?php include "header.php" ?>
    ...
    <div class="form-row">
        <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" id="search_lec_Name" name="search_lec_Name" autocomplete="off"
                value="<?php echo htmlspecialchars(trim($search_lec_Name, '%')); ?>">
        </div>
        <div class="form-group col-md-4">
            <label for="search_act_type">نوع النشاط : </label>
            <input type="text" class="form-control" id="search_act_type" name="search_act_type"  autocomplete="off"
                value="<?php echo htmlspecialchars(trim($search_act_type, '%')); ?>">
        </div>
        ...
        </div><h2>نشاطات التدريسيين</h2>
        <button type="button"><a href="insert_t.php">اضافة</a></button>
        <table class="table">
            <thead>
                <tr>
                    <th>اسم التدريسي</th>
